package org.sid.accountsbankservice.web;
...
import org.sid.accountsbankservice.mappers.AccountMapper;
import org.sid.accountsbankservice.repositories.BankAccountRepository;
import org.sid.accountsbankservice.service.AccountService;
   ...
   public List<BankAccount> bankAccounts(){
    ...
    public BankAccount bankAccount(@PathVariable String id){
        return  bankAccountRepository.findById(id)
                .orElseThrow(()->new RuntimeException(String.format("Account % s",id)));
    }
